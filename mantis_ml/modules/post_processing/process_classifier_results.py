...
class ProcessClassifierResults():
    ...
    def plot_auc_boxplots_across_all_clf(self, all_clf):
        ...
        fig.savefig(str(self.cfg.superv_figs_out / 'All_classifiers.AUC_distr_boxplots.pdf'), bbox_inches='tight')
...
if __name__ == '__main__':
    ...
    # gene_annot_list = pd.read_csv(str(self.cfg.data_dir / 'jasn_2019/jasn_core_genes.txt'), header=None)
    # gene_annot_list = gene_annot_list.loc[:, 0].tolist()
    ...
    #TODO: Avg feature importance foo all classifiers
    #TODO: IPA analysis for top hits
