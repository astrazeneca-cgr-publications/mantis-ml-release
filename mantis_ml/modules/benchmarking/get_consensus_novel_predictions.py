...
if __name__ == '__main__':
    ...
    all_clf = ['XGBoost', 'RandomForestClassifier', 'GradientBoostingClassifier', 'ExtraTreesClassifier', 'SVC', 'DNN', 'Stacking']
    get_cons_list_and_plot(novel_genes_df, all_clf, relaxation=relaxation)
