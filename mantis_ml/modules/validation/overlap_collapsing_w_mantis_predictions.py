...
class CollapsingMantisMlOverlap:
    ...
    def calc_stepwise_hypergeometric(self, clf_str, all_clf, top_ratio, disease='GGE', pval_cutoff=0.05,
        ...
        # > Additional string suffixes
        # if collapsing_top_ratio == -1:
        #     pval_cutoff_str = '.pval_cutoff_' + str(pval_cutoff)
        # else:
        #     pval_cutoff_str = '.collapsing_top_ratio_' + str(collapsing_top_ratio)
...
if __name__ == '__main__':
    ...
    # genes_to_remove = list(set(seed_genes + epilepsy_43_known_genes))
